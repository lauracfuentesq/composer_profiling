...
def get_feature_vectors(dataloader, dataframe, set_type, feature_tensors,k):
    ...
    #Ensure model is in evaluation mode
        ...
        torch.save(last_hidden_state_list,f'tensor_list_{set_type}_k{k}.pt')

        loader_tensor_list=torch.load(f'tensor_list_{set_type}_k{k}.pt')

        #loader_tensor_list=loader_tensor_list.tolist()
